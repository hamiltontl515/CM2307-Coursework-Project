...
public class Test{
    ...
    public static void main(String[] args) {
        ...
        User user1 = UserFactory.createUser("student", "U001", "Tim", "tim@unimail.com", "123456");
        User user2 = UserFactory.createUser("student", "U002", "Adam", "adam@unimail.com", "123456");
        User user3 = UserFactory.createUser("student", "U003", "Steve", "steve@unimail.com", "123456");
        User user4 = UserFactory.createUser("homeowner", "U004", "Mark", "mark@email.com", "123456");
        User user5 = UserFactory.createUser("homeowner", "U005", "Tammy", "tammy@unimail.com", "123456");
